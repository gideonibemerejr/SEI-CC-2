...
- A key principle of a relational database is to **avoid redundant data** by organizing data into multiple tables.
...
- Columns with redundant data make them candidates for being their own data entity...

---
### Identifying Data Entities - Exercise
<br>

#### Pair up and analyze the preliminary Ticket entity.<br><br>The goal is to identify separate Data Entities (and time permitting, their attributes) that would avoid redundant data.<br><br>We will review your findings in 5 minutes.<br><br>Don't cheat by looking ahead :)
