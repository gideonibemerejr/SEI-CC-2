...
It's worth pointing out that programming concepts such as variables, data types, control flow and functions apply to programming in general and that learning a new language amounts to not much more than learning a new syntax and a few idiosyncrasies about each particular language. 
