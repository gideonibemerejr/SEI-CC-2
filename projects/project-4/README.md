...
- Implement **authorization** by restricting CUD data functionality to appropriately authenticated users. Navigation should also respond to the login status of the user.
